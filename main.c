...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : USER_SW_1_Pin */
  ...
  /*Configure GPIO pins : RS485_EN_Pin LED_GREEN_Pin LED_DEBUG_Pin DCH_OVRD_Pin
                           BLEED_EN_Pin */
  ...
  /*Configure GPIO pins : PRECHG_EN_Pin INPUT_EN_Pin CELL_EN_Pin */
